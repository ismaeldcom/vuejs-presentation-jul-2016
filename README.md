...
- [Visual Studio Code](https://marketplace.visualstudio.com/items/liuji-jim.vue)
- [Brackets](https://github.com/pandao/brackets-vue)
- [JetBrains products](https://plugins.jetbrains.com/plugin/8057)

## eslint
- [Sublime Text](https://github.com/roadhump/SublimeLinter-eslint)
- [Sublime Text](https://github.com/albertosantini/sublimetext-buildnext)
- [Atom](https://atom.io/packages/linter-eslint)
- [Vim](https://github.com/scrooloose/syntastic/tree/master/syntax_checkers/javascript)
- [Visual Studio Code](https://marketplace.visualstudio.com/items?itemName=dbaeumer.vscode-eslint)
- [Brackets](https://github.com/zaggino/brackets-eslint)
- [JetBrains products](https://plugins.jetbrains.com/plugin/7494)
